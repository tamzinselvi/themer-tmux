...
set -g status-right "#[fg=${colorSet.shade2},bg=${colorSet.shade1}]#[fg=${colorSet.shade4},bg=${colorSet.shade2}] %H:%M:%S #[fg=${colorSet.shade4},bg=${colorSet.shade2}]#[fg=${colorSet.shade1},bg=${colorSet.shade4}] %d-%b-%y #[fg=${colorSet[`accent${i}`]},bg=${colorSet.shade4}]#[fg=${colorSet.shade0},bg=${colorSet[`accent${i}`]},bold] #H "
