...
set -g window-status-current-format "#[fg=${colorSet[`accent${i + 1}`]},bg=black] #I:#W#F "
...
set -g window-status-activity-bg ${colorSet[`accent${i + 1}`]}  # fg and bg are flipped here due to
